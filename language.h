...
// LCD Menu Messages
  ...
  #define MSG_LOAD_FILAMENT "Load Filament" ///p_k_3pdk change 
  #define MSG_UNLOAD_FILAMENT "Unload Filament" ///p_k_3pdk change
  #define MSG_TOWER_X "Auto Home! Tower X 0" ///p_k_3pdk change
  #define MSG_TOWER_Y "Auto Home! Tower Y 0" ///p_k_3pdk change
  #define MSG_TOWER_Z "Auto Home! Tower Z 0" ///p_k_3pdk change
  #define MSG_MID_PLATE "Auto Home! Plate 0" ///p_k_3pdk change
  #define MSG_PREHEAT_PETG_HE "Preheat E3DV6 PETG" ///p_k_3pdk change
  #define MSG_PREHEAT_PETG_HB "Preheat BED PETG" ///p_k_3pdk change
