...
{
    START_MENU();
    MENU_ITEM(back, MSG_MAIN, lcd_main_menu); //for all  p_k_3pdk changes look at the language.h to declare the menu inside your selcted language!
#ifdef SDSUPPORT
    //MENU_ITEM(function, MSG_AUTOSTART, lcd_autostart_sd);
#endif
    MENU_ITEM(gcode, MSG_DISABLE_STEPPERS, PSTR("M84"));
    MENU_ITEM(gcode, MSG_AUTO_HOME, PSTR("G28"));
    MENU_ITEM(gcode, MSG_LOAD_FILAMENT, PSTR("G F250 E620"));  ///p_k_3pdk change E distance depends on your bowden tube! 
    MENU_ITEM(gcode, MSG_UNLOAD_FILAMENT, PSTR("G F1000 E-600"));  ///p_k_3pdk E distance depends on your bowden tube!
    MENU_ITEM(gcode, MSG_TOWER_X, PSTR("G1 F1800 X-80 Y-50 Z0.0"));  ///p_k_3pdk change printer dimension are important! X and Y dimensions count from middle of printbed
    MENU_ITEM(gcode, MSG_TOWER_Y, PSTR("G1 F1800 X0 Y90 Z0.0"));  ///p_k_3pdk change printer dimension are important! X and Y dimensions count from middle of printbed
    MENU_ITEM(gcode, MSG_TOWER_Z, PSTR("G1 F1800 X80 Y-50 Z0.0"));  ///p_k_3pdk change printer dimension are important! X and Y dimensions count from middle of printbed
    MENU_ITEM(gcode, MSG_MID_PLATE, PSTR("G1 F1800 Z0.0"));  ///p_k_3pdk change
    MENU_ITEM(gcode, MSG_PREHEAT_PETG_HE, PSTR("M109 S245"));  ///p_k_3pdk change easier for changing just filament without heating the bed
    MENU_ITEM(gcode, MSG_PREHEAT_PETG_HB, PSTR("M140 S66"));  ///p_k_3pdk change
